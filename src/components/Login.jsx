...
const Login = () => {
  ...
  return (
    <div className="bg-gradient-to-r h-screen from-black to-blue-950">
      <div className=" text-white mx-20 ">
        {/* Header */}
        <header className="flex items-center justify-between ">
          <div className="flex items-center pl- space-x-2 pt-4">
            <img
              src={logo}
              alt="logo"
        ...
        <div className='bg-gray-900 p-8 rounded-lg w-[500px] mt-20 justify-center items-center'>
